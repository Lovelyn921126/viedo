...
public class GuavaCache {
	...
	return	CacheBuilder.newBuilder().concurrencyLevel(4).expireAfterWrite(4, TimeUnit.SECONDS).expireAfterAccess(100, TimeUnit.SECONDS).weakKeys().maximumSize(10000).recordStats()
	.build();
	}
