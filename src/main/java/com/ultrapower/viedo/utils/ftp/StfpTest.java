/*
 * FileName: StfpTest.java
 *
 * Company: 北京神州泰岳软件股份有限公司
 * Copyright - (C) Ultrapower Software CO., LTD. All Rights Reserved.
 */
...
public class StfpTest {
    ...
    /** 日志记录器  */
    //private Logger logger = Logger.getLogger(StfpTest.class);
    private final static Log logger = LogFactory.getLog(StfpTest.class);
    /** Session */
    ...
    public StfpTest(String host, int port, int timeout, String username, String password) {
        this.host = host;
        this.port = port;
    ...
    */
     ...
     * 例如makeDir("/testNOEXIST/testNOEXIST/testNOEXIST")，这是错误的。
     * </p>
     * @param dirName 目录
     * @return boolean
     */
    ...
    private String[] list(Filter filter) {
        ...
        return resultList.toArray(new String[5]);
    }
